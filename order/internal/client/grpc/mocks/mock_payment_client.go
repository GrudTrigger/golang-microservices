...
func (_m *PaymentClient) PayOrder(ctx context.Context, req model.RequestPay) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.RequestPay) (string, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.RequestPay) string); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, model.RequestPay) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, req model.RequestPay)) *PaymentClient_PayOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.RequestPay))
	})
	return _c
}
...
func (_c *PaymentClient_PayOrder_Call) RunAndReturn(run func(context.Context, model.RequestPay) (string, error)) *PaymentClient_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
