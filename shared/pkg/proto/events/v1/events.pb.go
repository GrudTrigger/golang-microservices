...
// OrderPaidRecorder - структура данных для заказа
type OrderPaidRecorder struct {
...
func (x *OrderPaidRecorder) Reset() {
	*x = OrderPaidRecorder{}
...
func (x *OrderPaidRecorder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderPaidRecorder) ProtoMessage() {}

func (x *OrderPaidRecorder) ProtoReflect() protoreflect.Message {
	mi := &file_events_v1_events_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use OrderPaidRecorder.ProtoReflect.Descriptor instead.
func (*OrderPaidRecorder) Descriptor() ([]byte, []int) {
	return file_events_v1_events_proto_rawDescGZIP(), []int{0}
}

func (x *OrderPaidRecorder) GetEventUuid() string {
	if x != nil {
		return x.EventUuid
	}
	return ""
...
func (x *OrderPaidRecorder) GetOrderUuid() string {
	if x != nil {
		return x.OrderUuid
	}
	return ""
...
func (x *OrderPaidRecorder) GetUserUuid() string {
	if x != nil {
		return x.UserUuid
	}
	return ""
...
func (x *OrderPaidRecorder) GetPaymentMethod() string {
	if x != nil {
...
func (x *OrderPaidRecorder) GetTransactionUuid() string {
	if x != nil {
...
// ShipAssembledRecorder - структура данных для выполненного заказа
type ShipAssembledRecorder struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EventUuid     string                 `protobuf:"bytes,1,opt,name=event_uuid,json=eventUuid,proto3" json:"event_uuid,omitempty"`
	OrderUuid     string                 `protobuf:"bytes,2,opt,name=order_uuid,json=orderUuid,proto3" json:"order_uuid,omitempty"`
	UserUuid      string                 `protobuf:"bytes,3,opt,name=user_uuid,json=userUuid,proto3" json:"user_uuid,omitempty"`
...
func (x *ShipAssembledRecorder) Reset() {
	*x = ShipAssembledRecorder{}
	mi := &file_events_v1_events_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ShipAssembledRecorder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShipAssembledRecorder) ProtoMessage() {}

func (x *ShipAssembledRecorder) ProtoReflect() protoreflect.Message {
	mi := &file_events_v1_events_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShipAssembledRecorder.ProtoReflect.Descriptor instead.
func (*ShipAssembledRecorder) Descriptor() ([]byte, []int) {
	return file_events_v1_events_proto_rawDescGZIP(), []int{1}
}

func (x *ShipAssembledRecorder) GetEventUuid() string {
	if x != nil {
		return x.EventUuid
	}
	return ""
...
func (x *ShipAssembledRecorder) GetOrderUuid() string {
	if x != nil {
		return x.OrderUuid
	}
	return ""
...
func (x *ShipAssembledRecorder) GetUserUuid() string {
	if x != nil {
		return x.UserUuid
	}
	return ""
...
func (x *ShipAssembledRecorder) GetBuildTimeSec() int64 {
	if x != nil {
...
const file_events_v1_events_proto_rawDesc = "" +
	"\n" +
	"\x16events/v1/events.proto\x12\tevents.v1\"\xc0\x01\n" +
	"\x11OrderPaidRecorder\x12\x1d\n" +
	"\n" +
	...
	"\x15ShipAssembledRecorder\x12\x1d\n" +
	"\n" +
	"event_uuid\x18\x01 \x01(\tR\teventUuid\x12\x1d\n" +
	"\n" +
	"order_uuid\x18\x02 \x01(\tR\torderUuid\x12\x1b\n" +
	"\tuser_uuid\x18\x03 \x01(\tR\buserUuid\x12$\n" +
	"\x0ebuild_time_sec\x18\x04 \x01(\x03R\fbuildTimeSecB<Z:github.com/rocker-crm/shared/pkg/proto/events/v1;events_v1b\x06proto3"
...
var file_events_v1_events_proto_goTypes = []any{
	(*OrderPaidRecorder)(nil),     // 0: events.v1.OrderPaidRecorder
	(*ShipAssembledRecorder)(nil), // 1: events.v1.ShipAssembledRecorder
}
